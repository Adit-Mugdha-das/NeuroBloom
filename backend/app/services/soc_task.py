...
class StockingsOfCambridgeTask:
    ...
    # Problem library - ALL puzzles BFS-validated, respect capacity constraints [3, 2, 1]
    # Stocking 0: max 3 balls, Stocking 1: max 2 balls, Stocking 2: max 1 ball
    PROBLEM_LIBRARY = {
        1: [
            # 1-move problems (10 problems)
            ([[0, 2], [], [1]], [[0], [2], [1]]),
            ([[0], [1, 2], []], [[0, 2], [1], []]),
            ([[1, 2], [0], []], [[1, 2], [], [0]]),
            ([[1, 0], [2], []], [[1, 0], [], [2]]),
