...
<div class="page-shell">
	<header class="topbar">
		<div>
			...
			<p class="subtext">Professional platform updates, operational notices, and research invitations relevant to your practice.</p>
		</div>
		<div class="topbar-actions">
			<button class="ghost-btn" on:click={() => goto('/doctor/dashboard')}>Back to Dashboard</button>
	...
	<main class="content">
		<section class="hero-card">
			<div>
				...
				<h2>All current administrative notices</h2>
				<p>Use this view to catch system announcements without interrupting the clinical workflow in the main dashboard.</p>
			</div>
			<div class="hero-meta">
				<span class="meta-pill">{notifications.length} active notices</span>
			</div>
		</section>
		...
		{:else if notifications.length === 0}
			<div class="state-card empty">
				...
				<p>Admin notices for doctors will appear here automatically.</p>
			</div>
		{:else}
...
<style>
	.page-shell {
		...
		background:
			...
			linear-gradient(165deg, #f8fafc 0%, #eff6ff 48%, #e2e8f0 100%);
		padding: 2rem;
