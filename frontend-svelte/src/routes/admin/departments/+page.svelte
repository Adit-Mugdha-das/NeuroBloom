...
<div class="admin-layout">
	...
	<main class="main-content">
		<header class="topbar">
			<div>
				<h1 class="page-title">{uiText("Department Management", $activeLocale)}</h1>
			</div>
		...
		<div class="content">
			...
			<section class="create-card">
				<h2>{uiText("Create Department", $activeLocale)}</h2>
				<div class="form-grid">
					<input type="text" placeholder={uiText("Department name", $activeLocale)} bind:value={form.name} />
					<input type="text" placeholder={uiText("Description (optional)", $activeLocale)} bind:value={form.description} />
			...
			{#if loading}
				<div class="loading-msg">{uiText("Loading departments...", $activeLocale)}</div>
			{:else if departments.length === 0}
				<div class="empty-state">
					<p>{uiText("No departments created yet.", $activeLocale)}</p>
				</div>
			{:else}
						...
						<div class="department-card">
							...
							<div class="metric-row">
								<div>
									...
									<p class="metric-label">{uiText("Doctors", $activeLocale)}</p>
								</div>
								<div>
