...
declare module "$app/types" {
	export interface AppTypes {
		RouteId(): "/" | "/baseline" | "/baseline/results" | "/baseline/tasks" | "/baseline/tasks/attention" | "/baseline/tasks/flexibility" | "/baseline/tasks/planning" | "/baseline/tasks/processing-speed" | "/baseline/tasks/visual-scanning" | "/baseline/tasks/working-memory" | "/dashboard" | "/empty-states-preview" | "/login" | "/progress" | "/register" | "/session-summary" | "/training" | "/training/dccs" | "/training/digit-span" | "/training/flanker" | "/training/gonogo" | "/training/inspection-time" | "/training/letter-number-sequencing" | "/training/operation-span" | "/training/pasat" | "/training/pattern-comparison" | "/training/plus-minus" | "/training/sdmt" | "/training/spatial-span" | "/training/stroop" | "/training/tower-of-london" | "/training/trail-making-a" | "/training/trail-making-b" | "/training/wcst";
		RouteParams(): {
