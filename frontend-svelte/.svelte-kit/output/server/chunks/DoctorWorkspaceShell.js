import { d as attr_style, b as slot, e as ensure_array_like, a as attr_class, u as unsubscribe_stores, f as bind_props, s as store_get } from "./index2.js";
...
function DoctorWorkspaceShell($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<div class="doctor-shell svelte-14lic82"><div class="doctor-shell__backdrop svelte-14lic82"></div> <div class="doctor-shell__inner svelte-14lic82"${attr_style(`--shell-max-width: ${maxWidth};`)}><header class="doctor-shell__header svelte-14lic82"><div class="doctor-shell__brand"><p class="doctor-shell__eyebrow svelte-14lic82">${escape_html(t(eyebrow))}</p> <h1 class="svelte-14lic82">${escape_html(t(title))}</h1> `);
    if (subtitle) {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<p class="doctor-shell__subtitle svelte-14lic82">${escape_html(t(subtitle))}</p>`);
    } else {
      $$renderer2.push("<!--[!-->");
    }
    $$renderer2.push(`<!--]--></div> <div class="doctor-shell__actions svelte-14lic82"><!--[-->`);
    slot($$renderer2, $$props, "actions", {});
    $$renderer2.push(`<!--]--> <button class="doctor-shell__logout svelte-14lic82">${escape_html(t("Logout"))}</button></div></header> <nav class="doctor-shell__nav svelte-14lic82"${attr("aria-label", t("Doctor Workspace"))}><!--[-->`);
    const each_array = ensure_array_like(navItems);
    for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
      let item = each_array[$$index];
      $$renderer2.push(`<button${attr_class("doctor-shell__nav-item svelte-14lic82", void 0, { "active": isActive(item.href) })}>${escape_html(t(item.label))}</button>`);
    }
