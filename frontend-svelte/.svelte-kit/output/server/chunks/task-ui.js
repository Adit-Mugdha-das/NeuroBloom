import { n as normalizeLocale } from "./index3.js";
...
function getTaskDifficultyDescription(taskKey, difficulty, targetLocale = "en", fallback = "") {
...
function getGoNoGoStimulusPair(stimulusSet, targetLocale = "en", fallback = {}) {
  const locale = normalizeLocale(targetLocale);
  const entry = GONOGO_STIMULUS_DISPLAY[String("").toLowerCase()];
...
export {
  getTaskDifficultyDescription as a,
  getGoNoGoStimulusPair as g
};
