...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<div class="training-shell svelte-1hs0zt0">`);
    {
      $$renderer2.push("<!--[!-->");
    }
    $$renderer2.push(`<!--]--> `);
    ...
    $$renderer2.push(`<!--]--> <div class="training-layout svelte-1hs0zt0">`);
    {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<section class="state-card svelte-1hs0zt0"><p>Loading your training plan...</p></section>`);
    }
