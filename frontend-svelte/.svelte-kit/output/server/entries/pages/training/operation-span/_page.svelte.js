...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<div class="ospan-container svelte-8fllqv" data-localize-skip=""><div class="ospan-inner svelte-8fllqv">`);
    {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<div class="loading-wrapper svelte-8fllqv">`);
