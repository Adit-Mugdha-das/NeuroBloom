...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<div class="dashboard-shell svelte-q47e6s" data-localize-skip="">`);
    {
      $$renderer2.push("<!--[!-->");
    }
    $$renderer2.push(`<!--]--> <header class="topbar svelte-q47e6s"><div class="brand-block svelte-q47e6s"><p class="eyebrow svelte-q47e6s">NeuroBloom</p> <h1 class="svelte-q47e6s">${escape_html(t("Your Brain Health Today"))}</h1> <p class="subcopy svelte-q47e6s">${escape_html(t("A calm view of your training progress, next step, and care support."))}</p></div> <div class="topbar-actions svelte-q47e6s">`);
    if (currentUser) {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<span class="user-email svelte-q47e6s">${escape_html(getDisplayName())}</span> <button class="ghost-btn svelte-q47e6s">${escape_html(t("Notifications"))} `);
      {
        $$renderer2.push("<!--[!-->");
      }
      $$renderer2.push(`<!--]--></button> <button class="ghost-btn svelte-q47e6s">${escape_html(t("Messages"))}</button> <button class="ghost-btn svelte-q47e6s">${escape_html(t("Settings"))}</button>`);
    } else {
      $$renderer2.push("<!--[!-->");
    }
    $$renderer2.push(`<!--]--> <button class="logout-btn svelte-q47e6s">${escape_html(t("Logout"))}</button></div></header> <main class="dashboard-main svelte-q47e6s">`);
    {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<section class="loading-panel svelte-q47e6s"><p>${escape_html(t("Loading your dashboard..."))}</p></section>`);
    }
