...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    let fullName = "";
    let loading = false;
    $$renderer2.push(`<div class="auth-container"><div class="auth-card"><h1>Create Account</h1> <p>Start your cognitive training journey</p> <div class="register-type-selector svelte-u2liyp"><button type="button"${attr_class(`type-btn ${stringify("active")}`, "svelte-u2liyp")}${attr("disabled", loading, true)}>👤 Patient</button> <button type="button"${attr_class(`type-btn ${stringify("")}`, "svelte-u2liyp")}${attr("disabled", loading, true)}>👨‍⚕️ Doctor</button></div> `);
    {
      $$renderer2.push("<!--[!-->");
    }
    $$renderer2.push(`<!--]--> `);
