...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<div class="progress-panel svelte-tllgyw">`);
    {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<section class="state-panel glass-card svelte-tllgyw"><p class="svelte-tllgyw">Loading progress overview...</p></section>`);
    }
    $$renderer2.push(`<!--]--></div>`);
  });
}
