  ...
  $$renderer.component(($$renderer2) => {
    ...
    DoctorWorkspaceShell($$renderer2, {
      ...
      children: ($$renderer3) => {
        {
          $$renderer3.push("<!--[-->");
          $$renderer3.push(`<section class="state-card svelte-1y7vnkp"><p>Loading progress reports...</p></section>`);
        }
        $$renderer3.push(`<!--]-->`);
      },
      $$slots: {
        ...
        actions: ($$renderer3) => {
          {
            $$renderer3.push(`<button class="outline-btn svelte-1y7vnkp">Back to Patient</button> `);
            $$renderer3.select(
            ...
            $$renderer3.push(` <button class="primary-btn svelte-1y7vnkp"${attr("disabled", generating, true)}>${escape_html("Generate Report")}</button>`);
          }
        }
      }
    });
