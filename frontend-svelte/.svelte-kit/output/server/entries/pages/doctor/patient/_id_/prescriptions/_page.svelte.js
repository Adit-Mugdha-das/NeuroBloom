  ...
  $$renderer.component(($$renderer2) => {
    ...
    DoctorWorkspaceShell($$renderer2, {
      ...
      children: ($$renderer3) => {
        {
          $$renderer3.push("<!--[-->");
          $$renderer3.push(`<section class="state-card svelte-zgicjs"><p class="svelte-zgicjs">Loading prescriptions...</p></section>`);
        }
        $$renderer3.push(`<!--]-->`);
      },
      $$slots: {
        ...
        actions: ($$renderer3) => {
          {
            $$renderer3.push(`<button class="outline-btn svelte-zgicjs">Patient Overview</button> <button class="outline-btn svelte-zgicjs">Reports</button> <button class="primary-btn svelte-zgicjs">Create Prescription</button>`);
          }
        }
      }
    });
