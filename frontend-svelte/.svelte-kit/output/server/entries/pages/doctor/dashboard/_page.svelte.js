  ...
  $$renderer.component(($$renderer2) => {
    ...
    DoctorWorkspaceShell($$renderer2, {
      ...
      children: ($$renderer3) => {
        ...
        {
          $$renderer3.push("<!--[-->");
          $$renderer3.push(`<section class="state-card svelte-8ogs16"><p>Loading doctor dashboard...</p></section>`);
        }
        $$renderer3.push(`<!--]-->`);
      },
      $$slots: {
        ...
        actions: ($$renderer3) => {
          {
            $$renderer3.push(`<button class="header-action svelte-8ogs16">Messages</button> <button class="header-action notification svelte-8ogs16">Notifications `);
            {
              $$renderer3.push("<!--[!-->");
            }
