...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    DoctorWorkspaceShell($$renderer2, {
      ...
      children: ($$renderer3) => {
        $$renderer3.push(`<section class="hero-card svelte-ulkjam"><div><p class="hero-kicker svelte-ulkjam">Practice Updates</p> <h2 class="svelte-ulkjam">${escape_html(notifications.length)} active notices</h2> <p class="svelte-ulkjam">Doctor-facing platform notices, feature updates, and invitations are stored here instead of interrupting patient review.</p></div></section> `);
        {
          $$renderer3.push("<!--[-->");
          $$renderer3.push(`<section class="state-card svelte-ulkjam"><p class="svelte-ulkjam">Loading notifications...</p></section>`);
        }
        $$renderer3.push(`<!--]-->`);
      },
      $$slots: { default: true }
